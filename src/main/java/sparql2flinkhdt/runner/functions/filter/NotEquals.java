...
public class NotEquals {
    ...
    public static boolean eval(SerializableDictionary dictionary, E_NotEquals expression, HashMap<String, Integer[]> sm) {
...
//public class NotEquals{
//
//    public static boolean eval(Dictionary dictionary, E_NotEquals expression, HashMap<String, Integer[]> sm) {
//        Expr arg1 = expression.getArg1();
//        Expr arg2 = expression.getArg2();
//
//        Boolean flag = false;
