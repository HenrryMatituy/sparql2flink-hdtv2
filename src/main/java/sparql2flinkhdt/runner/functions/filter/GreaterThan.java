...
public class GreaterThan {
    ...
    public static boolean eval(SerializableDictionary dictionary, E_GreaterThan expression, HashMap<String, MappingValue> sm) {
        ...
        try {
            ...
            System.err.println("Error en GreaterThan.eval: " + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
